...
silent only
cd ~/Work/Udacity/SelfDriving/ExtendedKalman
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 src/FusionEKF.cpp
badd +0 src/kalman_filter.h
badd +0 src/FusionEKF.h
badd +0 src/kalman_filter.cpp
badd +0 src/measurement_package.h
badd +21 src/tools.h
badd +9 src/tools.cpp
argglobal
silent! argdel *
argadd src/FusionEKF.cpp
edit src/kalman_filter.cpp
...
49
normal! zo
let s:l = 42 - ((0 * winheight(0) + 21) / 43)
...
12
normal! zo
let s:l = 50 - ((21 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
50
...
55
normal! zo
let s:l = 45 - ((21 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
...
wincmd w
argglobal
edit src/measurement_package.h
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
159
normal! zo
let s:l = 118 - ((0 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
118
